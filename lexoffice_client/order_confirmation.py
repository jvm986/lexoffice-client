...
class OrderConfirmationReadOnly(BaseModel):
    id: UUID
    organizationId: UUID
...
class OrderConfirmationWritable(BaseModel):
...
class OrderConfirmation(OrderConfirmationReadOnly, OrderConfirmationWritable):
    pass
